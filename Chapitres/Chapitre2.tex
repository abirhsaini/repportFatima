...
\textbf{But} & Permettre à l'utilisateur de sélectionner des produits, de les ajouter à son panier, de saisir les informations nécessaires et de préparer la commande pour le paiement. \\ \hline
\textbf{Acteur} & Acheteur \\ \hline
\textbf{Pre-conditions} &
\begin{itemize}
    \item L'acheteur a choisi les produits qu'il souhaite acheter et les a ajoutés à son panier.
    \item L'acheteur a créé un compte sur le site de Chanel ou peut effectuer une commande en tant qu'invité.
\end{itemize} \\ \hline
\textbf{Post-conditions} &
\begin{itemize}
    \item Les informations de livraison sont fournies, et le mode de livraison (à domicile ou click and collect) est choisi.
    \item L'adresse de facturation est saisie.
\end{itemize} \\ \hline
\textbf{Scénario normal} &
\begin{itemize}
    \item L'acheteur parcourt le site et sélectionne les produits qu'il souhaite acheter, puis les ajoute à son panier.
    \item Une fois les produits sélectionnés, l'acheteur clique sur "Passer commande".
    \item Le site demande à l'acheteur de choisir le mode de livraison (à domicile ou click and collect).
    \item L'acheteur entre les informations de livraison.
    \item L'acheteur saisit l'adresse de facturation, qui peut être différente de l'adresse de livraison.
    \item Le site vérifie que toutes les informations requises sont correctement saisies et que le panier est prêt pour le paiement.
\end{itemize} \\ \hline
\textbf{Scénario alternatif} &
\begin{itemize}
    \item L'acheteur rencontre des problèmes avec la connexion Internet ou le chargement du site.
    \item Un produit sélectionné n'est plus disponible en stock.
    \item L'acheteur décide d'annuler ou de modifier la commande avant de passer à la caisse.
\end{itemize} \\ \hline
\end{longtable}
